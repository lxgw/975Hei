...
目前只有简体中文（SC）版本，剔除 'locl' 特性以减小字体体积。

## 预览
![](./documentation/975HEI1.PNG)
![](./documentation/975HEI2.PNG)
![](./documentation/975HEI3.PNG)
![](./documentation/975HEI4.PNG)
![](./documentation/975HEI5.PNG)
...
## 字体下载
1. 进入 [Release](https://github.com/lxgw/975Hei/releases) 页面下载 TTF 文件。
